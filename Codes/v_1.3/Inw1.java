		...
		for(ArcShape as : matching) {
			...
			for(ArcShape as1 : matchingClone) {
				...
				if(as1.getX() == as.getX() && as1.getY() == as.getY()) {
					...
					flag = false;
				} else if (as1.getX() == as.getX()){
					System.out.println("Vertex Error : Vertex \"" + as.getX() + "\" already used.");
					flag = false;
				} else if(as1.getY() == as.getY()){
					System.out.println("Vertex Error : Vertex \"" + as.getY() + "\" already used.");
					flag = false;
