...
public class MainWindow extends JFrame implements ActionListener, ChangeListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(!s2.isEmpty()) {
			inw2 = new Inw2(field1.getText(), parser.parseArcs(s, false), parser.parseArcs(s2, true));
			inw2.isMatching();
			dp.setComponentShape(inw2.generateGraphicsComponent());
		} else  {
			inw1 = new Inw1();
			inw1.setWord(field1.getText());
			inw1.setMatching(parser.parseArcs(s, false));
			inw1.isMatching();
