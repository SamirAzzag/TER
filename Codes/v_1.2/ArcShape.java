...
public class ArcShape implements ComponentShape{
	...
	public void draw(Graphics g) {
		...
		if(!reverse)
			...
			shape = new Arc2D.Double (x * DrawPanel.spaceBetweenNode, DrawPanel.verticalPosition - (y-x) * DrawPanel.spaceBetweenNode/2 + DrawPanel.nodeDiameter, (y-x) * DrawPanel.spaceBetweenNode, (y-x) * DrawPanel.spaceBetweenNode, 180, 180, Arc2D.OPEN);
