...
public class Inw1 {
	...
	protected List<ArcShape> matching1; /* upper Arcs */
	...
	public boolean isMatching() {
		...
		List<ArcShape> matchingClone = new ArrayList<ArcShape>(matching1);
	...
	public List<ArcShape> getMatching1() {
		return matching1;
	}

	public void setMatching1(List<ArcShape> matching) {
		this.matching1 = matching;
	}
